...
import '../../../Shared/network/Users_Product_Service.dart';
import '../../../Shared/styles/colors.dart';
import '../../../model_Screen/user_product_model.dart';
...
class _SearchProductScreenState extends State<SearchProductScreen> {
  ...
  void initState() {
    ...
    super.initState();
    context.read<UserProductProvider>().emptySearchedProductsList();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                ...
                SizedBox(
                  ...
                  child: TextField(
                    ...
                    onSubmitted: (productName) {
                      // log(productName);
                      context.read<UserProductProvider>().getSearchedProducts(productName: productName);
                    },
      ...
      body: Consumer<UserProductProvider>(
        builder: (context,userProductProvider,chiled){
          if(userProductProvider.productsFetched==false){
           // return Center(child: CircularProgressIndicator(color: amber,));
            return const SizedBox();
          }
          else{
            if (userProductProvider.searchProduct.isEmpty){
              return Center(child: Text(
                'Oops! Prouduct Not Found',
                style: textTheme.bodyMedium!.copyWith(color: red,fontWeight: FontWeight.w600),
              ),);
            }else{
              return ListView.builder(
                itemCount: userProductProvider.searchProduct.length,
                  shrinkWrap: true,
                  itemBuilder: (context,index){
                  ProductModel currentProduct=userProductProvider.searchProduct[index];
                  return InkWell(
                    onTap: ()async{
                              ...
                              const SizedBox(height: 5,),
                                  ...
                                  RichText(
                                      ...
                                      text: TextSpan(
                                        children: [
                                          TextSpan(
                                            text: currentProduct.discountedPrice.toString()
                                          ),
                                          TextSpan(
                                            text: 'L.E ',
                                            style: textTheme.bodyMedium,
